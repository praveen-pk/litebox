...
fn optee_smc_handler_entry_inner(
    ...
    debug_serial_println!("Entering optee_smc_handler, smc_args_pfn: {:#x}", smc_args_pfn);

    let smc_args_addr = smc_args_pfn << litebox_platform_lvbs::mshv::vtl1_mem_layout::PAGE_SHIFT;
    debug_serial_println!("Entering optee_smc_handler, smc_args_addr: {:#x}", smc_args_addr);
...
fn handle_open_session(
    ...
    debug_serial_println!(">1> handle_open_session1: OpenSession decoded TA UUID: :{:?}", ta_uuid);
